...
@section('title')
    @parent
    {{ lang('Admin/Project.add_project') }}
@endsection
...
@section('content')
    ...
    <section class="col-lg-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form id="form-add-project" role="form" method="post" class="needs-validation" novalidate>
                    {!! csrf_field() !!}
            ...
            <div class="card-footer">
                <div class="col-md-12">
                    <button type="submit" class="btn btn-primary" form="form-add-project">
                        {{ lang('Admin/Project.add_project') }}
                    </button>
                </div>
            </div>
