...
@section('title')
    @parent
    {{ lang('Admin/Translation.edit_language') }}
@endsection
...
@section('content')
    ...
    <section class="col-lg-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form id="form-update-language" role="form" method="post" class="needs-validation" novalidate>
                    {!! csrf_field() !!}
            ...
            <div class="card-footer">
                <div class="col-md-12">
                    <button type="submit" class="btn btn-primary" form="form-update-language">
                        {{ lang('Admin/Translation.update_language') }}
                    </button>
                </div>
            </div>
        </div>
